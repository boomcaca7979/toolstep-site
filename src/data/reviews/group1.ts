...
export const group1Reviews: ProductReviewEntry[] = [
  ...
  },
  {
    ...
    testingSummary: 'Based on manufacturer specifications and published product documentation, the Herman Miller Aeron (Size B, graphite, with PostureFit SL) is evaluated for its ergonomic support, Pellicle mesh durability, thermal comfort, and adjustability. Feature analysis compares it head-to-head against the Steelcase Leap V2 and Branch Ergonomic Chair. This is an independent editorial review; no unit was provided by Herman Miller, and the evaluation is based on the documented specifications cited above.',
