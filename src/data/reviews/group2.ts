...
export const group2Reviews: ProductReviewEntry[] = [
  ...
  },
  {
    ...
    testingSummary: 'Based on product documentation, feature analysis, pricing comparison, and specification evaluation, this review covers the FlexiSpot E7\'s dual-motor frame, 220-lb capacity, 22.6 to 48.4-inch height range, 5-year warranty, and four programmable presets. Pricing is compared against the Vari Electric and Branch Standing Desk. This is an independent editorial review; no unit was provided by FlexiSpot, and the evaluation is based on the documented specifications cited above.',
