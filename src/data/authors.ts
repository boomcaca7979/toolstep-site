...
export const authors: Author[] = [
  {
    ...
    bio: 'Marcus has spent the last 8 years testing office hardware in his home lab — everything from standing desks to mechanical keyboards to USB-C docks. Before joining ToolStep, he worked as a product designer at a furniture startup where he learned how chairs and desks are actually engineered. He has personally tested over 200 office products and keeps a permanent testing setup with 6 desks and 12 chairs in rotation.',
    equipment: [
  ...
  },
  {
    ...
    bio: 'Sarah reviews software tools and input devices for productivity workflows. She spent 5 years as a project manager at a remote-first company, where she tested every collaboration and note-taking tool on the market. She brings a practical, workflow-first perspective to reviews — she cares less about spec sheets and more about whether a tool actually saves you time on a real Tuesday.',
    equipment: [
  ...
  },
  {
    ...
    bio: 'The ToolStep editorial team conducts collaborative reviews where multiple testers use the same product and compare notes. These reviews are edited by our senior staff and represent the consensus of our testing panel. We use this byline for roundups and comparison pieces where no single reviewer is the primary tester.',
    equipment: [
