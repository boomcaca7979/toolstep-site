...
export const authors: Author[] = [
  {
    ...
    equipment: [
      'Reference hardware for context: FlexiSpot E7 standing desk',
      'Herman Miller Aeron (reference chair)',
      'Logitech MX Master 3S + MX Keys S',
      'CalDigit TS4 Thunderbolt dock',
      'BenQ ScreenBar Halo',
    ],
    experience: '8 years reviewing office hardware. Former product designer at a furniture startup (2018–2022). Has analyzed 200+ office products through specification analysis and documented comparison workflows.',
    expertise: [
...

  {
    slug: 'jordan-lee',
    name: 'Jordan Lee',
    role: 'Software & AI Tools Analyst',
    avatar: 'https://i.pravatar.cc/300?u=jordan-lee-toolstep',
    bio: 'Jordan covers software and AI tools for ToolStep, with a focus on project management platforms, developer tools, and productivity workflows. Reviews are built from official product documentation, published pricing, release notes, and documented user reports — following the ToolStep evaluation protocol, which is based on publicly available information rather than hands-on lab testing.',
    equipment: [],
    experience: '6 years working in software teams using the tools covered here. Researches each product from official documentation, changelogs, and public user feedback.',
    expertise: [
      'Project management and developer tools',
      'AI productivity tools',
      'SaaS pricing and plan analysis',
    ],
    reviews: [],
    social: {},
  },
  {
    slug: 'maya-patel',
    name: 'Maya Patel',
    role: 'Design & Web Tools Analyst',
    avatar: 'https://i.pravatar.cc/300?u=maya-patel-toolstep',
    bio: 'Maya analyzes design platforms and website builders for ToolStep. Her comparisons are grounded in official documentation, published feature lists, template and plan analysis, and publicly available user feedback — following the ToolStep evaluation protocol rather than hands-on lab testing.',
    equipment: [],
    experience: '5 years as a frontend developer and design-tool power user. Evaluates products from official documentation, plan comparisons, and documented workflows.',
    expertise: [
      'Design tools and design systems',
  ...
  },
  {
    slug: 'lena-rivera',
    name: 'Lena Rivera',
    role: 'Hardware Specifications Analyst',
    avatar: 'https://i.pravatar.cc/300?u=lena-rivera-toolstep',
    bio: 'Lena covers office hardware for ToolStep, comparing monitors, docks, and workspace accessories. Her reviews are based on manufacturer specification sheets, published measurements, warranty documentation, and verified user reports — following the ToolStep evaluation protocol, which relies on publicly available information rather than hands-on lab testing.',
    equipment: [],
    experience: '5 years researching computer hardware. Evaluates products through specification analysis, documented measurements, and published reliability data.',
    expertise: [
      'Monitors and display specifications',
      'Docks and connectivity',
      'Specification and warranty analysis',
    ],
    reviews: [],
    social: {},
  },
